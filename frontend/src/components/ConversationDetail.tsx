...
export default function ConversationDetail({ conversation, onClose }: ConversationDetailProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-950/20 backdrop-blur-sm dark:bg-black/40">
      <div className="w-full max-w-3xl max-h-[80vh] flex flex-col bg-white border border-zinc-200 rounded-2xl shadow-2xl overflow-hidden dark:bg-zinc-900 dark:border-zinc-800">
